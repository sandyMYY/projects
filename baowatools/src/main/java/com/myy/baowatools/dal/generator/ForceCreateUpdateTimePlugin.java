...
public class ForceCreateUpdateTimePlugin extends PluginAdapter {
    ...
    public boolean validate(List<String> warnings) {
        insertTimeColumnNames = GeneratorUtils.splitToSet(properties.getProperty("insertTimeColumns"), ",");
        lastUpdateTimeColumnNames = GeneratorUtils.splitToSet(properties.getProperty("lastUpdateTimeColumns"), ",");
