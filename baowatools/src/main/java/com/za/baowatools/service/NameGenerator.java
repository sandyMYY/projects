...
public class NameGenerator {
    ...
    public static String setGivenName() {
        ...
        try {
            givenName = new String(bArr, "GB2312");
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 10; ++i) {
            SurName = setFamilyName();
            ForeName1 = setGivenName();
            ForeName2 = setGivenName();
            System.out.print("姓名" + (i + 1) + ":" + SurName + ForeName1 + ForeName2 + "\n");
        }
